...
import { ImagePlus, X, Loader2, Check, Building2 } from "lucide-react";
  ...
  return (
    <div className="space-y-5">
          ...
          <div className="relative shrink-0">
            {logoUrl ? (
              <img
                src={logoUrl}
                alt="Logo"
                className="h-16 w-16 rounded-xl object-cover border border-slate-600 bg-slate-900"
              />
            ) : (
              <div
                className="h-16 w-16 rounded-xl flex items-center justify-center text-white text-lg font-bold border border-slate-600"
            ...
            {logoUrl && (
              <button
                ...
                className="absolute -top-2 -right-2 w-5 h-5 rounded-full bg-slate-700 border border-slate-600 flex items-center justify-center text-slate-300 hover:text-red-400 hover:border-red-400 transition-colors"
        ...
        <div>
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              className="w-10 h-10 rounded-lg border border-slate-600 cursor-pointer bg-transparent shrink-0"
            />
            <Input
              value={primaryColor}
              onChange={(e) => setPrimaryColor(e.target.value)}
      ...
      <div>
        ...
        <div
          className="rounded-xl border border-slate-700 p-4 flex items-center gap-3"
          style={{ background: `linear-gradient(135deg, ${primaryColor}1a 0%, ${accentColor}1a 100%)` }}
        >
          {logoUrl ? (
